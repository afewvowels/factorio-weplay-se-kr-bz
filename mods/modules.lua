...
for index = 1, 8 do
  ...
  data.raw.module[name].effect.productivity.bonus = 0.4 + (0.2 * index)
  data.raw.module[name].effect.speed.bonus = 0.6 + (0.2 * index)
  data.raw.module[name].effect.consumption.bonus = 0.05 * index

  -- Speed Module changes
  data.raw.module[speedName].effect.speed.bonus = data.raw.module[speedName].effect.speed.bonus + (0.3 * index)
